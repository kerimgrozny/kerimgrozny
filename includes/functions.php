...
function pagesForSelectedSubject($pages){                   
    ...
    while($page = mysqli_fetch_assoc($page_set)){
        ...
        $output .= "</td></tr>";
        $output .= "<td><a href=\"edit_post.php?ID=".urlencode($page["ID"])."&User=".urlencode($page["CreatedBy"])."&Content=".urlencode($page["Content"])."&Subject=".urlencode($page["Subject"])."\">Изменить</a></td>";
