...
<div class="row"><!--content row start-->
	<h1>Создание профессионального сайта</h1>
	...
	<div class="col-xs-12 col-md-6">
		<img class="img-responsive" src="images/serviceImages/web-design-bristol.jpg" alt="Веб Дизайн">
		</p>
	</div>
...
<div class="row"><!--content row start-->
	...
	<div class="col-sm-12 col-md-6">
		<img class="img-responsive" src="images/serviceImages/photoediting.jpg" alt="Фотомонтаж">
	</div>
	<div class="col-xs-12 col-md-6">
