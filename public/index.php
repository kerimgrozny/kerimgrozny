...
<div class="container" id="content"><!--content container start-->
	...
	<div class="row"><!--content row start-->
		<h1>Профессиональный дизайн</h1>
		<div class="col-sm-12 col-md-6">
			<img class="img-responsive" src="images/serviceImages/web_theme.png" alt="Веб дизайн темы">
		</div>
		<div class="col-xs-12 col-md-6">
			<p>Сайт с индивидуальным дизайном позволит Вам выделиться на фоне конкурентов и привлечь большее число клиентов. Дизайн изготавливается на основе заполненного Вами брифа, в котором учитываются Ваши пожелания по оформлению.</p>
